...
return new class extends Migration
{
    public function up(): void
    {
        ...
        foreach ([
            SystemNotificationKey::BirthdayNotificationWitnessCopy,
            SystemNotificationKey::BirthdayNotificationSummary,
        ] as $key) {
    ...
    public function down(): void
    {
        ...
        DB::table('system_notification_recipient_settings')
            ->whereIn('notification_key', [
                SystemNotificationKey::BirthdayNotificationWitnessCopy->value,
                SystemNotificationKey::BirthdayNotificationSummary->value,
            ])
            ->delete();
    }
};
