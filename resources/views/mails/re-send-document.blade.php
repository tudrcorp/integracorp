...
<body>
    ...
    <div style="margin: auto; width: 600px; padding: 10px; text-align: center;">
        <p><span style="font-weight: bold; font-size: 1.2em;">Estimado(a) {{ $name_ti }}</span> </p>
        <p><span style="font-weight: bold; font-size: 1.2em;">¡Bienvenido(a) a TuDrEnCasa! 🌟</span> </p>
        <p>Esperamos se encuentre bien. Le informamos que hemos generado su {{ $title }} , el cual se encuentra adjunto al presente correo.</p>
    </div>
