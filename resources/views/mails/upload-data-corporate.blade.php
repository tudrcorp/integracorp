...
<body>
    ...
    <div style="margin: auto; width: 400px; padding: 10px; text-align: center;">
        <p><span style="font-weight: bold; font-size: 1.2em;">¡Bienvenido(a) a TuDrEnCasa! 🌟</span> </p>
        <p>El agente {{ $name_agent }} ha subido la data corporativa asociada a la cotización con el número {{ $code }}.<br>
        Por favor, realicen el proceso correspondiente para atender esta solicitud a la brevedad posible. Cualquier información adicional o requerimiento se les será comunicado oportunamente.</p>
    </div>
