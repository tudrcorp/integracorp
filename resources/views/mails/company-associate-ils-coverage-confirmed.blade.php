...
<head>
    ...
    <title>Cobertura confirmada</title>
</head>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="padding: 10px 20px; color: #333333; font-size: 14px; line-height: 1.6;">
                            <h2 style="margin: 0 0 6px; color: #1f2937; font-size: 18px;">Cobertura confirmada</h2>
                            <p style="margin: 0 0 16px; color: #6b7280; font-size: 13px;">Notificación generada el {{ $generatedAt }}</p>

                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 16px;">
                                <tr>
                                    <td style="padding: 14px 16px; border-radius: 8px; background-color: #ecfdf5; border: 1px solid #6ee7b7; color: #065f46; font-size: 14px; line-height: 1.6;">
                                        <strong style="color: #047857;">El cliente está cubierto en su totalidad.</strong>
                                        El analista confirmó que realizó toda la gestión que garantiza la cobertura del asociado.
                                        El documento del voucher ILS va adjunto a este correo.
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse; margin: 0 0 16px;">
                                <tr>
                                    <td colspan="2" style="padding: 10px 12px; border: 1px solid #e5e7eb; background-color: #f3f4f6; font-weight: bold; color: #111827;">Voucher ILS</td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 12px; border: 1px solid #e5e7eb; width: 35%; color: #6b7280;">Número</td>
                                    <td style="padding: 8px 12px; border: 1px solid #e5e7eb; color: #111827; font-weight: bold;">{{ $voucherCode }}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 12px; border: 1px solid #e5e7eb; color: #6b7280;">Vigencia desde</td>
                                    <td style="padding: 8px 12px; border: 1px solid #e5e7eb; color: #111827;">{{ $voucherDateInit }}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 12px; border: 1px solid #e5e7eb; color: #6b7280;">Vigencia hasta</td>
                                    <td style="padding: 8px 12px; border: 1px solid #e5e7eb; color: #111827;">{{ $voucherDateEnd }}</td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse; margin: 0 0 16px;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 8px 12px; border: 1px solid #e5e7eb; color: #111827;">{{ $associate->age !== null ? $associate->age.' años' : '—' }}</td>
                                </tr>
                                <tr>
