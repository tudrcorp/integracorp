...
<body>
    ...
    <div style="margin: auto; width: 600px; padding: 10px; text-align: center;">
        ...
        <p>¡Nos complace darte la más cordial bienvenida🌟, queremos informarte que tu afiliación ha sido procesada con éxito, y estamos muy contentos de tenerte como parte de nuestra comunidad.

            Adjunto a este correo encontrarás tu Tarjeta de Afiliado , un documento importante que acredita tu incorporación a nuestros servicios. Por favor, guárdalo en un lugar seguro y no dudes en contactarnos si necesitas ayuda para revisarlo o interpretarlo.
