...
<head>
    ...
    <title>Cambio de fecha de cita</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:620px; background:#ffffff; border:1px solid #e5e7eb; border-radius:16px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:0 28px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#eff6ff; border:1px solid #3b82f6; border-radius:12px;">
                                <tr>
                                    <td align="center" style="padding:14px 18px; color:#1e3a8a; font-size:16px; font-weight:bold;">
                                        Cambio de fecha de cita — {{ $orderLabel }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:20px 28px 8px 28px; color:#334155; font-size:15px; line-height:1.6;">
                            <p style="margin:0 0 12px 0;">
                                El paciente reprogramó la asistencia acordada. Detalle del cambio:
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:6px 28px 26px 28px; color:#334155; font-size:14px; line-height:1.6;">
                            <p style="margin:0;">Favor actualizar su agenda con la nueva fecha de asistencia.</p>
