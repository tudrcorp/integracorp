...
<body>
    ...
    <div style="margin: auto; width: 600px; padding: 10px; text-align: center;">
        ...
        <p>El agente {{ $name_agent }} ha generado una nueva solicitud de cotización con el código {{ $code }}, a nombre de {{ $name_user }} . Por favor, realicen el proceso correspondiente para atender esta solicitud a la brevedad posible. Cualquier información adicional o requerimiento se les será comunicado oportunamente.</p>
    </div>
