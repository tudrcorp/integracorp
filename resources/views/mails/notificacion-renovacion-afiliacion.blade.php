...
<head>
    ...
    <title>NOTIFICACION DE RENOVACION</title>
</head>
                    ...
                    <tr>
                        <td align="center" style="padding: 15px 10px; color: #333333; font-size: 12px; line-height: 1.6;">
                            <p style="margin: 0; color: #555555;">
                                Se le informa que se la afiliación con el código: <span style="font-weight: bold;">{{ $codigo }}</span> esta proxima a su renovación.<br>
                                <span style="font-weight: bold;">Dias restantes: {{ $dias }}</span>.
                            </p>
                            <p style="margin: 0; color: #555555;">
