...
<body>
    ...
    <div style="margin: auto; width: 600px; padding: 10px; text-align: center;">
        ...
        <p>Estimado(a), </p>
        <p>Esperamos que se encuentre bien. Le informamos que en el presente correo encontrará adjunto el informe de pago correspondiente a la mensualidad de su plan de seguro , detallando la fecha de pago, monto aplicado y otros datos relevantes.
            Si tiene alguna duda o requiere información adicional, no dude en contactarnos.
            Agradecemos por su puntualidad en el pago y por confiar en nuestro servicio de asistencia de viaje.</p>
        <br>
        <br>
        <p>Atentamente,</p>
        <p>TuDrEnCasa</p>
