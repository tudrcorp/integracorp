...
<head>
    ...
    <title>Documentos de telemedicina</title>
    <style>
        body {
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:620px; background:#ffffff; border:1px solid #e5e7eb; border-radius:16px; overflow:hidden;">
                    ...
                    <tr>
                        <td align="center" style="padding:10px 28px 24px 28px; color:#334155; font-size:15px; line-height:1.65;">
                            ...
                            <p>Le informamos que en este correo van adjuntos los informes generados por su consulta médica de telemedicina.</p>
                            <p>Por favor, revíselos con atención y guárdelos de forma segura. Si tiene alguna duda sobre las indicaciones, no dude en consultarnos.</p>
