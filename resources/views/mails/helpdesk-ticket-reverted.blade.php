...
<head>
    ...
    <title>Ticket de soporte revertido</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 8px 24px 16px 24px;">
                            <p style="margin: 0; font-size: 15px; line-height: 1.5; color: #3a3a3c;">
                                Hola{{ filled($creatorName) ? ', '.$creatorName : '' }},
                            </p>
                            <p style="margin: 12px 0 0 0; font-size: 15px; line-height: 1.5; color: #3a3a3c;">
                                El Product Owner <strong>{{ $revertedBy }}</strong> revirtió el ticket que usted creó. Revise el motivo, complete la información solicitada y vuelva a enviarlo para su evaluación.
                            </p>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background: #f2f2f7; border-radius: 12px; border: 1px solid #e5e5ea;">
                                ...
                                <tr>
                                    <td style="padding: 0 16px 16px 16px;">
                                        <p style="margin: 0 0 4px 0; font-size: 12px; font-weight: 600; color: #8e8e93;">Motivo</p>
                                        <p style="margin: 0; font-size: 15px; line-height: 1.45; color: #1c1c1e; white-space: pre-wrap;">{{ $reason }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 0 16px 16px 16px;">
