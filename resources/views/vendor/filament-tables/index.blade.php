                                        ...
                                        @foreach ($records as $record)
                                            ...
                                            @if (! $isGroupsOnly)
                                                <tr
                                                    ...
                                                    @php
                                                        $rowGroupColor = $record instanceof \Illuminate\Database\Eloquent\Model ? $record->getAttribute('group_color') : ($record['group_color'] ?? null);
                                                        $rowStyle = $rowGroupColor && is_string($rowGroupColor) && str_starts_with($rowGroupColor, '#')
                                                            ? 'background-color: color-mix(in srgb, ' . e($rowGroupColor) . ' 18%, transparent); border-left: 4px solid ' . e($rowGroupColor)
                                                            : null;
                                                    @endphp
                                                    @if($rowStyle)
                                                        style="{{ $rowStyle }}"
