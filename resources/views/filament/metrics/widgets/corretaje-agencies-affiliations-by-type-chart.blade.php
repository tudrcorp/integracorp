...
<x-filament-widgets::widget class="fi-wi-chart fi-metrics-agents-by-state-chart fi-metrics-agents-by-affiliations-chart fi-metrics-agencies-affiliations-drill">
    <x-filament::section
    ...
    >
        @if ($isDrillDown)
            <x-slot name="afterHeader">
                <button
                    type="button"
                    wire:click="resetDrillDown"
                    wire:loading.attr="disabled"
                    class="fi-metrics-agencies-affiliations-drill__back"
                >
        ...
        <div
            class="fi-metrics-agencies-affiliations-drill__stage"
            wire:key="{{ $this->getIosBarChartWireKey() }}-stage"
            x-data="{ ready: false }"
