...
<x-filament-widgets::widget class="fi-wi-chart fi-metrics-agents-by-state-chart fi-metrics-cotizaciones-by-agency-chart">
    <x-filament::section
    ...
    >
        <div>
            @if ($hasData)
                <div class="fi-metrics-cotizaciones-chart__summary mb-3 sm:mb-4">
                    @include('filament.metrics.partials.cotizaciones-chart-mom-summary', [
                        'summary' => $this->getMomSummaryViewData(),
                    ])
                </div>
            @endif
