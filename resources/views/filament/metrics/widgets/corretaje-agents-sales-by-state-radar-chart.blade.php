...
<x-filament-widgets::widget class="fi-wi-chart fi-metrics-agents-by-state-chart fi-metrics-agents-sales-by-state-radar-chart">
    <x-filament::section
    ...
    >
        <div>
                ...
                <div class="fi-metrics-agents-by-state-chart__empty" role="status">
                    <div class="fi-metrics-agents-by-state-chart__empty-icon" aria-hidden="true">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-9">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 3.75a8.25 8.25 0 1 1 0 16.5 8.25 8.25 0 0 1 0-16.5Z" />
            ...
            @else
                <div class="fi-metrics-agents-by-state-chart__canvas fi-metrics-agents-sales-by-state-radar-chart__canvas">
                    <div
                        x-load
