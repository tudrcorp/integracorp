    ...
    >
        ...
        >
            <div>
                ...
                @if (filled($supplierLabel))
                    <p class="mt-0.5 max-w-md truncate text-xs text-gray-500 dark:text-gray-400" title="{{ $supplierLabel }}">
                        {{ $supplierLabel }}
                    </p>
                @endif
            </div>
                ...
                >
                    ...
                    <div class="max-w-sm space-y-1">
                        ...
                        <p class="text-xs leading-relaxed text-gray-600 dark:text-gray-400">
                            Estamos generando el documento. La primera vez puede tardar más; las siguientes suelen abrir al instante mientras no cambien los datos del proveedor.
                        </p>
                    </div>
                </div>
                <iframe
                    x-ref="pdfPreview"
                    title="Vista previa ficha del proveedor"
