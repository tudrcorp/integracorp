...
<div class="fi-scoped space-y-5" wire:ignore.self>
    ...
    >
        ...
        >
            <div>
                <p class="text-xs uppercase tracking-wide text-gray-400 dark:text-gray-500">Ficha corporativa</p>
                ...
                >
                    ...
                    <div class="max-w-sm space-y-1">
                        ...
                        <p class="text-xs leading-relaxed text-gray-600 dark:text-gray-400">
                            Estamos generando el documento. La primera vez puede tardar más; las siguientes suelen abrir al instante mientras no cambien los datos de la afiliación ni de los afiliados asociados.
                        </p>
                    </div>
                </div>
                <iframe
                    x-ref="pdfPreview"
                    title="Vista previa ficha afiliación corporativa"
