...
<div class="fi-tdev-process-notes-modal space-y-4 px-0.5 py-1">
    <div
        ...
        <div class="px-4 py-3">
            ...
            <p class="mt-1 text-sm text-gray-700 dark:text-gray-300">
                ...
                modificación de este movimiento TDEV.
            </p>
    ...
    <div
        ...
        <div class="mb-3 flex items-center gap-2">
            <span class="text-[0.65rem] font-semibold uppercase tracking-[0.12em] text-gray-500 dark:text-gray-400">
                Historial de observaciones de proceso
            </span>
        </div>
        @if ($hasNote)
            <div
        ...
        @else
            <div
                ...
                <p class="font-medium text-gray-600 dark:text-gray-300">Sin observaciones de proceso</p>
                <p class="mt-1 text-xs">Aún no se ha añadido una observación de proceso a este movimiento.</p>
            </div>
        @endif
    </div>

    <p class="text-center text-[0.7rem] text-gray-400 dark:text-gray-500">
        Voucher {{ $record->vaucher }} · {{ $record->pasajero }}
    </p>
</div>
