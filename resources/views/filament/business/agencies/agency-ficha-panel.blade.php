@php
    ...
    $codeLabel = AgencyFichaPdfService::codeLabel($record);
    ...
    <div class="flex flex-col gap-1 sm:flex-row sm:items-start sm:justify-between">
        <div>
            ...
            <p class="mt-1 max-w-2xl text-xs leading-relaxed text-slate-500 dark:text-slate-400">
                Vista previa con datos de la agencia y notas internas (más recientes primero). Marca Tu Dr en Casa.
    ...
    <div class="mt-5 grid gap-4 lg:grid-cols-2">
        ...
        <div
            ...
            <button
                ...
                wire:target="queueAgencyFichaPdfWhatsApp"
                ...
                @click="$wire.queueAgencyFichaPdfWhatsApp({{ (int) $record->getKey() }}, phone)">
                <span wire:loading.remove wire:target="queueAgencyFichaPdfWhatsApp">Enviar WhatsApp</span>
                <span wire:loading wire:target="queueAgencyFichaPdfWhatsApp">Enviando…</span>
            </button>
        </div>
    </div>
</section>
