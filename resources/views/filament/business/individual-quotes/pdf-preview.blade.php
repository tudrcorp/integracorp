        ...
        @if (filled($pdfPreviewUrl))
            <div class="bg-gray-50/80 p-3 dark:bg-gray-950/60">
                ...
                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    Si la vista previa no carga en el recuadro, use «Abrir en pestaña» para visualizar el PDF.
                </p>
            </div>
        ...
        @else
            <div class="px-4 py-10 text-center">
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    El PDF de esta cotización aún no ha sido generado. Intente nuevamente en unos segundos.
                </p>
            </div>
        @endif
    </div>
