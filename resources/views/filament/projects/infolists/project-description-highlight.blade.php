    ...
    @if (! $hasDescription)
        <div class="rounded-2xl border border-dashed border-gray-300 bg-gray-50/90 p-8 text-center dark:border-white/15 dark:bg-white/[0.03]">
            ...
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                Agrega el alcance o detalle del proyecto al editarlo.
            </p>
        </div>
    @else
        <div
            class="project-description-highlight overflow-hidden rounded-2xl border border-gray-200/90 bg-white shadow-sm dark:border-white/10 dark:bg-gray-950/90 dark:shadow-none"
            style="--project-color: {{ $projectColor }};"
        >
            <div class="project-description-highlight__header border-b border-gray-100 px-4 py-3 sm:px-5 dark:border-white/10">
                <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <span class="project-description-highlight__badge inline-flex shrink-0 items-center gap-1.5 rounded-full border px-3 py-1 text-[11px] font-semibold uppercase tracking-wide">
            ...
            <div class="project-description-highlight__body px-4 py-4 sm:px-5 sm:py-5">
                <p class="project-description-highlight__text text-justify text-sm font-medium leading-7 sm:text-[0.9375rem] sm:leading-8">
                    {{ $description }}
                </p>
            </div>
        </div>
        ...
        <style>
            ...
            .project-description-highlight__header {
            ...
            .project-description-highlight__badge {
            ...
            .project-description-highlight__body {
                background: linear-gradient(
                    180deg,
            ...
            .project-description-highlight__text {
                margin: 0;
                padding: 0;
                text-indent: 0;
                color: rgb(30 41 59);
            ...
            :is(.dark, .dark *) .project-description-highlight__badge {
            ...
            :is(.dark, .dark *) .project-description-highlight__body {
                background: linear-gradient(
                    180deg,
            ...
            :is(.dark, .dark *) .project-description-highlight__text {
