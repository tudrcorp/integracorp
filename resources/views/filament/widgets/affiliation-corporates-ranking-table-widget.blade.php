@php
    ...
    $widgetClass = \App\Support\Filament\AffiliationCorporatesRankingTableUi::widgetClass($variant);
...
>
    ...
    <div
        ...
        @if ($variant === 'agent')
            ...
            x-on:affiliation-corporates-agent-filter-start.window="filtering = true"
            x-on:affiliation-corporates-agent-filter-end.window="filtering = false"
        @endif
    >
        @if ($showPeriodFilters)
            <div class="ac-ranking-agency-header">
                <h3 class="ac-ranking-agency-header__title">
                    {{ \App\Support\Filament\AffiliationCorporatesRankingTableUi::heading('agency') }}
                </h3>
