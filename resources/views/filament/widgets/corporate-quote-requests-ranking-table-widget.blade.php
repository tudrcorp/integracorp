@php
    ...
    $widgetClass = \App\Support\Filament\CorporateQuoteRequestsRankingTableUi::widgetClass($variant);
...
>
    ...
    <div
        ...
        @if ($variant === 'agent')
            ...
            x-on:corporate-quote-requests-agent-filter-start.window="filtering = true"
            x-on:corporate-quote-requests-agent-filter-end.window="filtering = false"
        @endif
    >
        @if ($showPeriodFilters)
            <div class="ac-ranking-agency-header">
                <h3 class="ac-ranking-agency-header__title">
                    {{ \App\Support\Filament\CorporateQuoteRequestsRankingTableUi::heading('agency') }}
                </h3>
