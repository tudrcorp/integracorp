...
<body>
                ...
                <tr>
                    <td style="padding: 2 !important;
                        ...
                        <span style="font-size: 14px;
                                ...
                                padding: 0;
                        ">
                            Documento: J-{{ $data_factura['ci_rif_ti'] }}</span>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 2 !important;
    ...
    <div style="display: blog; justify-content: center; align-items: center; text-align: center; margin-top: 300px; padding: 20px">
        <table>
            <thead>
                <tr>
                    ...
                    <tr>
                        <td style="font-weight: normal;">
                            <p style="line-height: 1;">
                                Ref. de Pago: {{ $data_factura['reference'] }}<br>
                                Forma de Pago: {{ $data_factura['payment_method'] }}<br>
                                Validado: Dpto. Finanzas: {{ $data_factura['emission_date'] }}
                            </p>
                        </td>
                    </tr>
            </tbody>
