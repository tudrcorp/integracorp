...
<body>
    ...
    <div
        style="display: blog; justify-content: center; align-items: center; text-align: center; margin-top: 370px; padding: 20px">
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                @endfor
                <tr>
                    <td colspan="2" style="font-weight: bold; text-align: right;">Monto Total: {{ number_format($data['total_amount'], 2) }}US$
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    {{-- <div style="position: absolute; top: 617px; left: 500px; padding: 10px; width: 100%;">
        <p class="sin-margen" style="font-size: 14px; text-transform: uppercase;">
