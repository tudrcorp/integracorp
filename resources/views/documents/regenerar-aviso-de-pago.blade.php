    ...
    <div class="doc-root">
        ...
        @php
            if (! empty($data['desde'] ?? null) && ! empty($data['hasta'] ?? null)) {
                ...
                $vigenciaHasta = match ($data['frequency'] ?? '') {
                    'MENSUAL' => date('d/m/Y', strtotime('+1 months')),
                    'TRIMESTRAL' => date('d/m/Y', strtotime('+3 months')),
                    'SEMESTRAL' => date('d/m/Y', strtotime('+6 months')),
                    'ANUAL' => date('d/m/Y', strtotime('+1 years')),
