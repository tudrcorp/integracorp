...
new #[Layout('components.layouts.interactive')] class extends Component {
    ...
    public function mount()
    {
        ...
        $this->client = UtilsController::getClientCor($this->quote);
    ...
    public function downloadConditions()
    {
        ...
        $corporate_quote = CorporateQuote::where('id', $id)->first();
    ...
    <div
        ...
        <ul class="flex flex-col mb-4 lg:mb-6">
            <li
                ...
                <span>
                    Costos
                    <a href="{{ route('volt.cor.corporate_quote', ['quote' => $this->quote]) }}"
