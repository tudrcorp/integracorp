...
it('registra el recurso de histórico de renovaciones en afiliaciones sin crear ni editar', function (): void {
    $source = file_get_contents(dirname(__DIR__, 2).'/app/Filament/Administration/Resources/AffiliationRenovationHistories/AffiliationRenovationHistoryResource.php');
...
it('reutiliza la tabla e infolist compartidos del histórico de renovaciones en administration', function (): void {
    $tableSource = file_get_contents(dirname(__DIR__, 2).'/app/Filament/Administration/Resources/AffiliationRenovationHistories/Tables/AffiliationRenovationHistoriesTable.php');
...
it('define el slug del recurso de histórico en el panel administration', function (): void {
