...
it('registra el recurso de renovaciones en afiliaciones sin crear ni editar', function (): void {
    $source = file_get_contents(dirname(__DIR__, 2).'/app/Filament/Business/Resources/Renovations/RenovationResource.php');
...
it('reutiliza la tabla e infolist compartidos de renovaciones', function (): void {
    $tableSource = file_get_contents(dirname(__DIR__, 2).'/app/Filament/Business/Resources/Renovations/Tables/RenovationsTable.php');
