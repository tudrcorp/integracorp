...
it('relation managers de consulta en telemedicina exponen tablas con UX consistente', function (): void {
    $base = dirname(__DIR__, 2).'/app/Filament/Telemedicina/Resources/TelemedicineConsultationPatients/RelationManagers';
