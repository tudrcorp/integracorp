...
it('el feed instagram permite swipe, doble toque y descargar', function (): void {
    ...
    expect($page)
        ...
        ->toContain('Descargar')
        ->toContain('Me gusta')
        ->toContain('sf-reel__stage')
        ->toContain('sf-reel__chrome')
        ->toContain('sf-reel__like')
        ->toContain('sf-reel__download')
        ...
        ->toContain('.sf-reel__photo')
        ->toContain('object-fit: contain')
        ->toContain('-webkit-line-clamp: 2')
        ->and($css)->not->toContain('.sf-reel__shade')
        ->and($page)->not->toContain('sf-reel__shade')
        ->and($css)->toContain('.sf-reel__chrome')
        ->toContain('flex: 0 0 auto')
        ->toContain('background: linear-gradient(180deg, #0a1a32, #061018)')
