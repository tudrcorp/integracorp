...
class TravelAgentRegistration extends Component
{
    ...
    {
        $this->agency = TravelAgency::query()
            ->with('parentAgency')
    ...
    public function submit(): void
    {
        ...
        TravelAgencyPublicRegistrar::registerAgent($this->agency, [
            'name' => $validated['fullName'],
            'cargo' => $validated['position'] ?: null,
            'email' => $validated['email'] ?: null,
            'phone' => $validated['phone'] ?: null,
            'fechaNacimiento' => $validated['birthDate'] ?: null,
        ]);
    ...
    {
        return view('livewire.travel-agent-registration')
            ->layout('layouts.tdev-agent-registration', [
                'faviconUrl' => $this->agency->faviconUrl(),
                'pageTitle' => 'Registro de agente · '.$this->agency->name,
            ]);
    }
}
