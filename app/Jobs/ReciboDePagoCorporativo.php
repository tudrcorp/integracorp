...
class ReciboDePagoCorporativo implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $pdf = Pdf::loadView('documents.aviso-de-pago-corporativo', [
                'data' => $this->data
            ]);
    ...
    {
        Log::error("ADMINISTRACION: Error en ReciboDePagoCorporativo [Invoice: {$this->data['invoice_number']}]: " . $e->getMessage(), [
            'exception' => $e,
            'data' => $this->data
        ]);
    }
    ...
    public function failed(Throwable $exception): void
    {
        ...
        Log::critical("ADMINISTRACION: El Job ReciboDePagoCorporativo falló definitivamente para la factura: {$this->data['invoice_number']}");
    }
}
