...
class GeneratePdfImagenologia implements ShouldQueue
{
    ...
    private function generatePDF($data)
    {
        ...
        $pdf = Pdf::loadView('documents.imagenologia', compact('data'));
