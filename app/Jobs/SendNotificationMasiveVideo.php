...
class SendNotificationMasiveVideo implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        foreach ($recipient as $user) {
            ...
            Notification::make()
                ...
                ->body('La notificación masiva ha sido enviada correctamente.')
                ->icon('heroicon-m-tag')
                ->iconColor('success')
                ->success()
    ...
    private function sendNotifications()
    {
        ...
        $masiveNotification->sendVideo($this->record);
    }
