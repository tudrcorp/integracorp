    ...
    public static function approvePayment($record, $data)
    {
        ...
        try {
            ...
            if (! isset($data['collections'])) {
                ...
                SecurityAudit::log('AUDIT_SALE_REGISTERED', 'paid-membership-corporate.approve-payment', [
                    'flow' => 'first-register',
                    'sale_id' => $sales->id,
                ...
                SecurityAudit::log('AUDIT_PAYMENT_APPROVED', 'paid-membership-corporate.approve-payment', [
                    'flow' => 'first-register',
                    'paid_membership_corporate_id' => $record->id,
            ...
            SecurityAudit::log('AUDIT_PAYMENT_APPROVAL_FAILED', 'paid-membership-corporate.approve-payment', [
                'paid_membership_corporate_id' => $record->id ?? null,
                'error' => $th->getMessage(),
            ]);
