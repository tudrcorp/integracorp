...
class RenovationCorporateExportCsvController extends Controller
{
    private const CACHE_PREFIX = 'renovation_corporate_export_csv_';
    ...
    public function __invoke(Request $request): StreamedResponse
    {
        ...
        return new StreamedResponse(function () use ($ids, $headers): void {
            ...
            RenovationCorporate::query()
                ...
                ->orderBy('id')
                ->lazyById(100)
                ->each(function (RenovationCorporate $record) use ($handle): void {
     ...
     */
    private function buildRow(RenovationCorporate $record): array
    {
