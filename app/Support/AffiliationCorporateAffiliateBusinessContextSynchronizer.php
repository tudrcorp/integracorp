...
{
    public function sync(AffiliationCorporate $affiliationCorporate, mixed $businessUnitId, mixed $businessLineId, mixed $specificBusinessUnit = null): int
    {
        ...
        return AffiliateCorporate::query()
            ...
            ->update([
                ...
                'specific_business_unit' => AffiliationAffiliateBusinessContextSynchronizer::normalizeSpecificBusinessUnit($specificBusinessUnit),
            ]);
    }
}
