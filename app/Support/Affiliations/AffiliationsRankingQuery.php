...
class AffiliationsRankingQuery
{
    /**
     * Agencias con afiliaciones individuales. Cuenta primero en affiliations
    ...
    /**
     * Agentes con afiliaciones individuales. Si hay código de agencia, filtra
