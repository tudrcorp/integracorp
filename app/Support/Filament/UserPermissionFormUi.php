...
final class UserPermissionFormUi
{
    ...
    private const MODULE_THEMES = [
        ...
        'METRICAS' => [
            ...
            'accent' => '#0f766e',
            'accent_soft' => '#ccfbf1',
            'accent_ring' => 'rgba(45,212,191,0.4)',
            'icon' => Heroicon::OutlinedChartBarSquare,
            'subtitle' => 'Indicadores y KPI',
        ],
    ];
    ...
    private const GROUP_ICONS = [
        ...
        'MÉTRICAS Y KPI' => Heroicon::OutlinedChartBarSquare,
        'METRICAS' => Heroicon::OutlinedChartBarSquare,
        'NEGOCIOS' => Heroicon::OutlinedBriefcase,
        'COTIZACIONES' => Heroicon::OutlinedCurrencyDollar,
        'PROVEEDORES' => Heroicon::OutlinedTruck,
        'OPERACIONES' => Heroicon::OutlinedCog6Tooth,
    ...
    public static function permissionsEmptyStateHtml(): HtmlString
    {
        return new HtmlString(
            ...
            .'<p class="mx-auto mt-1 max-w-md text-sm text-slate-500 dark:text-slate-400">Ve a la pestaña <strong>Módulos</strong> y asigna al menos un panel para configurar permisos.</p>'
            .'</div>'
        );
    }
