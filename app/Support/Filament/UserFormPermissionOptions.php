...
class UserFormPermissionOptions
{
    ...
    private const NAV_TO_LEGACY_SLUG_ALIASES = [
        ...
        'operationinventoryubicationresource' => ['almacenes'],
        'operationinventoryproductresource' => ['productos'],
        'operationinventoryproductcategoryresource' => ['categorias'],
        'manageoperationinventoryparameters' => ['parametros-inventario'],
        ...
        'portalhelpcontactresource' => ['contactos-ayuda-portal'],
        'telemedicinelistlaboratoryresource' => ['lista-laboratorios'],
        'telemedicineliststudyresource' => ['lista-estudios'],
        'telemedicinelistspecialistresource' => ['lista-especialistas'],
