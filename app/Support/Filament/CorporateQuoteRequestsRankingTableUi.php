...
class CorporateQuoteRequestsRankingTableUi
{
    /**
    ...
    public static function apply(
        ...
        $columns = [
            self::rankColumn(),
            self::nameColumn($modelClass, $nameAttribute, $nameLabel, $variant),
        ...
        return $table
            ...
            ->extraAttributes([
                'class' => $tableClass,
                'data-cqr-ranking-variant' => $variant,
            ])
            ->columns($columns)
    ...
    {
        return TextColumn::make('total_requests')
            ->label('Total')
            ->numeric()
            ->sortable()
            ->alignEnd()
