        ...
        return [
            [
                ...
                'data' => [
                    ...
                    'tracks' => [
                        ['label' => 'Operaciones', 'hint' => 'Cupos, OS, facturas y CxP'],
                        ...
                        ['label' => 'Marketing', 'hint' => 'Campañas con Mailchimp'],
            ...
            [
                'id' => 'ops-cxp',
                'type' => 'ops-admin',
                'title' => 'Operaciones × Administración · de la OS al pago',
                'subtitle' => 'Operaciones carga la factura del proveedor. El sistema genera la cuenta por pagar. Administración cierra el ciclo con el comprobante. Una orden, una factura, una CxP.',
                'module' => 'Operaciones',
                'icon' => '◎',
                'color' => '#007AFF',
                'speaker_note' => 'La acción «Cargar factura» en la orden de servicio llama a ServiceOrderAccountsPayableRegistrar: nace la CxP en Pendiente por pagar y la OS pasa a Facturado. El comprobante se carga en Cuentas por pagar. Si luego se corrige la factura, el pago ya registrado (referencia, banco, montos) no se toca.',
                'highlights' => [
                    'Cargar factura en la orden de servicio (una o varias del mismo proveedor)',
                    'La cuenta por pagar se genera sola, en Pendiente por pagar',
                    'El comprobante de pago marca la factura como Pagada',
                    'Corregir la factura nunca borra un pago ya registrado',
                ],
                'tags' => ['Órdenes', 'Facturas', 'CxP'],
                'data' => [
                    'kicker' => 'Mismo documento, dos pantallas, un solo rastro',
                    'invoice_caption' => 'Operaciones · Cargar factura',
                    'receipt_caption' => 'Cuentas por pagar · Cargar comprobante',
                    'steps' => [
                        [
                            'title' => 'Orden de servicio',
                            'detail' => 'Cotizada y lista. Aún no hay compromiso de pago.',
                        ],
                        [
                            'title' => 'Cargar factura',
                            'detail' => 'Número, control, fechas, monto y PDF del proveedor.',
                        ],
                        [
                            'title' => 'Nace la CxP',
                            'detail' => 'Pendiente por pagar. La OS pasa a Facturado.',
                        ],
                        [
                            'title' => 'Cargar comprobante',
                            'detail' => 'Referencia, banco y archivo. La CxP queda Pagada.',
                        ],
                    ],
                    'invoice_modal' => [
                        'heading' => 'Cargar factura del proveedor',
                        'description' => 'Al guardar, la orden pasa a estatus administrativo «Facturado».',
                        'order' => 'OS-4521',
                        'supplier' => 'Clínica QA',
                        'quoted' => 'US$ 250,50',
                        'invoice_number' => '00012345',
                        'control_number' => '00-0012345',
                        'issued_at' => '01/09/2026',
                        'registered_at' => '05/09/2026',
                        'amount_usd' => '250,50',
                        'file' => 'factura-00012345.pdf',
                        'rif' => 'J-30011122-3',
                    ],
                    'receipt_modal' => [
                        'heading' => 'Cargar comprobante de pago',
                        'description' => 'Factura 00012345 · Clínica QA · US$ 250,50',
                        'status' => 'Pagada',
                        'reference' => 'REF-777',
                        'paid_at' => '08/09/2026',
                        'bank' => 'BANESCO',
                        'amount_usd' => '250,50',
                        'file' => 'comprobante-banesco.pdf',
                    ],
                    'promise' => 'Operaciones factura. Administración paga. El sistema no deja huecos: una OS no genera dos CxP, y un pago ya cargado sobrevive a cualquier corrección de factura.',
                ],
            ],
            [
                'id' => 'generador-planes',
            ...
            [
                'id' => 'mailchimp',
                'type' => 'integration',
                'title' => 'TDG Marketing × Mailchimp',
                'subtitle' => 'El analista arma la campaña en TDG Marketing. Mailchimp sincroniza la audiencia, envía el masivo y devuelve el reporte: aperturas, clics, rebotes y bajas.',
                'module' => 'Marketing',
                'icon' => '✉',
                'color' => '#FF9500',
                'speaker_note' => 'No es un SMTP improvisado. Las masivas van por Mailchimp Marketing (una campaña, un campaign_id). Cumpleaños, eventos y pruebas van por Mailchimp Transactional. El reporte vuelve al historial; no se relanza si Mailchimp ya aceptó el envío.',
                'highlights' => [
                    'Campañas masivas: Audience, segmento estático y un solo envío',
                    'Cumpleaños, eventos e invitaciones por correo transaccional',
                    'Reporte de abiertos, clics, rebotes y bajas en el historial',
                    'Baja y dirección fiscal las inserta Mailchimp en la campaña real',
                ],
                'tags' => ['Mailchimp', 'Masivos', 'Reportes'],
                'data' => [
                    'kicker' => 'Integración activa',
                    'tdg_label' => 'TDG Marketing',
                    'tdg_hint' => 'El analista despacha desde el panel',
                    'tdg_logo' => 'image/logoNewTDG.png',
                    'tdg_logo_dark' => 'image/logoTDG.png',
                    'partner_label' => 'Mailchimp',
                    'partner_hint' => 'Entrega, medición y cumplimiento',
                    'partner_logo' => 'image/brands/mailchimp-logo.svg',
                    'partner_mark' => 'image/brands/mailchimp-freddie.svg',
                    'flow_labels' => ['Sincroniza', 'Envía', 'Reporta'],
                    'steps' => [
                        [
                            'title' => 'Campaña en TDG Marketing',
                            'detail' => 'El analista elige destinatarios, HTML y asunto. Un clic encola el envío; no hay lotes de 15 ni Gmail de por medio.',
                        ],
                        [
                            'title' => 'Audience y segmento',
                            'detail' => 'Mailchimp sincroniza los contactos, crea un segmento estático y deja un campaign_id. Si ya lo aceptó, no se relanza.',
                        ],
                        [
                            'title' => 'Mailchimp envía',
                            'detail' => 'El masivo sale por Mailchimp Marketing. Cumpleaños, eventos y pruebas van por Mailchimp Transactional.',
                        ],
                        [
                            'title' => 'El reporte vuelve',
                            'detail' => 'Abiertos, clics, rebotes duros y bajas llegan al historial de despacho. El analista ve el resultado, no una caja negra.',
                        ],
                    ],
                    'capabilities' => [
                        [
                            'title' => 'Masivos',
                            'detail' => 'Una campaña por envío. Mailchimp escala; TDG Marketing no satura SMTP.',
                        ],
                        [
                            'title' => 'Transaccional',
                            'detail' => 'Cumpleaños, invitaciones de eventos y envíos de prueba por Mandrill.',
                        ],
                        [
                            'title' => 'Reportes',
                            'detail' => 'Abiertos, clics, rebotes y bajas se refrescan en el historial.',
                        ],
                        [
                            'title' => 'Cumplimiento',
                            'detail' => 'Enlace de baja y dirección fiscal los pone Mailchimp en la campaña real.',
                        ],
                    ],
                    'promise' => 'Marketing despacha con una plataforma de envíos de clase mundial, sin salir de TDG Marketing.',
                ],
            ],
            [
                'id' => 'intra',
