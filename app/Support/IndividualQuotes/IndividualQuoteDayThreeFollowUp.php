...
final class IndividualQuoteDayThreeFollowUp
{
    ...
    public static function groupKey(\App\Models\IndividualQuote $quote): string
    {
        return IndividualQuoteFollowUp::groupKey($quote);
    }
    ...
    {
        return IndividualQuoteFollowUp::quoteNumericSuffix($code);
    }
    ...
    public static function whatsappBody(Collection $quotes): string
    {
        ...
        return <<<TEXT
        ¡Hola, *{$allyName}*! Te saludamos de Tu Doctor en Casa 🩺🏡, vimos la cotización para {$clientNames}. ¿Hay alguna duda o necesitas apoyo para cerrar esta venta hoy?
        ¡Quedamos atentos!
