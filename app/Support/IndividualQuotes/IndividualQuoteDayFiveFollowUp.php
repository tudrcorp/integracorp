...
final class IndividualQuoteDayFiveFollowUp
{
    public const FOLLOW_UP_DAYS = 5;

    public const ELIGIBLE_STATUS = IndividualQuoteFollowUp::ELIGIBLE_STATUS;

    public const FOLLOW_UP_VIDEO = 'imagenes-seguimiento-cotizaciones/video-mensaje-dos.mp4';
    ...
    public static function followUpVideoUrl(): string
    {
        return IndividualQuoteFollowUp::publicAssetUrl(self::FOLLOW_UP_VIDEO);
    }
    ...
    public static function whatsappBody(Collection $quotes): string
    {
        ...
        return <<<TEXT
        ¡Hola, *{$allyName}*! Por la cotización de {$clientNames}, a continuación verás un video que explica por qué deben elegirnos en Tu Doctor en Casa 🩺🏡.

        {$footer}
        TEXT;
    }

    public static function followUpVideoCaption(): string
    {
        return '🎬 Video informativo — Tu Dr. En Casa';
    }
}
