...
final class HelpdeskTicketModalActions
{
    ...
    {
        return SharedHelpdeskTicketModalActions::makeAddNoteAction('administration');
    }

    public static function makeUpdateStatusAction(): Action
    {
        return SharedHelpdeskTicketModalActions::makeUpdateStatusAction('administration');
    }

    public static function makeUpdatePriorityAction(): Action
    {
        return SharedHelpdeskTicketModalActions::makeUpdatePriorityAction('administration');
    }
}
