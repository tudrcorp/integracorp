...
class CreateHelpdesk extends CreateRecord
{
    ...
    protected function afterCreate(): void
    {
        ...
        try {
            ...
            SecurityAudit::log('AUDIT_HELPDESK_TICKET_CREATED', 'administration.helpdesks.create', [
            ...
            SecurityAudit::log('AUDIT_HELPDESK_TICKET_CREATE_FAILED', 'administration.helpdesks.create', [
                'panel' => 'administration',
                'helpdesk_id' => $ticket->getKey(),
                'created_by' => $ticket->created_by,
                'error' => $th->getMessage(),
