...
namespace App\Filament\Administration\Resources\RrhhDeduccions\Schemas;
...
class RrhhDeduccionForm
{
    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                Tabs::make('rrhhDeduccionFormTabs')
                    ->columnSpanFull()
                    ->extraAttributes([
                    ...
                    ->tabs([
                        Tab::make('Información principal')
                            ...
                            ->schema([
                                Fieldset::make('Identificación de la deducción')
                                        ...
                                        Fieldset::make('Datos generales')
                                            ...
                                            ->schema([
                                                ...
                                                Textarea::make('description')
                                                    ...
                                                    ->required()
                                                    ->rows(3)
                                                    ->placeholder('Detalle o condiciones de la deducción.')
                                                    ->helperText('Explica el alcance o criterio de esta deducción.')
                                                    ->columnSpanFull(),
                                            ])
                                            ->columns(1)
                                            ->columnSpanFull(),
                                ...
                                Fieldset::make('Aplicación')
                                    ->extraAttributes(['class' => self::SECTION_CARD])
                                    ->schema([
                                        Fieldset::make('Alcance de la deducción')
                                            ->extraAttributes(['class' => self::INNER_CARD])
                                            ->schema([
                                                ToggleButtons::make('aplicacion')
                                                    ...
                                                    ->helperText('Puede aplicar la deducción a un departamento completo o a un colaborador específico.')
                                                    ->columnSpanFull(),
                                        ...
                                        Fieldset::make('Tipo de cálculo')
                                            ...
                                            ->schema([
                                                ...
                                                TextInput::make('monto')
                                                    ...
                                                    ->prefix('US$')
                                                    ->placeholder('0.00')
                                                    ->helperText('Se descuenta como monto fijo sobre el sueldo total. Use punto(.) para decimales.')
