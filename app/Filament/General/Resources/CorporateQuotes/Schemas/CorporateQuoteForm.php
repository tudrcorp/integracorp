...
namespace App\Filament\General\Resources\CorporateQuotes\Schemas;
        ...
        return $schema
            ...
            Section::make('COTIZACION CORPORATIVA')
                ...
                ->schema([
                    ...
                    //     ->live()
                    //     ->helperText('Si el campo vacio se asignará la agencia por defecto TDG-100.')
                    //     ->searchable()
                    //     ->prefixIcon('heroicon-s-globe-europe-africa')
                    //     ->hiddenOn(Pages\EditCorporateQuote::class)
                    //     ->preload(),
                    Select::make('code_agent')
                        ->label('Agente')
                        ->options(Agent::all()->pluck('code_agent', 'code_agent'))
                        ->live()
                        ->helperText('Si el campo vacio se asignará la agencia por defecto el id del usuario de sesion.')
                        ->searchable()
                        ->hiddenOn('edit')
                        ->prefixIcon('heroicon-s-globe-europe-africa')
                        ->preload(),
