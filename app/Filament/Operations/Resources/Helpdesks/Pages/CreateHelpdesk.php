...
class CreateHelpdesk extends CreateRecord
{
    ...
    protected function afterCreate(): void
    {
        ...
        try {
            ...
            SecurityAudit::log('AUDIT_HELPDESK_TICKET_CREATED', 'operations.helpdesks.create', [
                'panel' => 'operations',
            ...
            SecurityAudit::log('AUDIT_HELPDESK_TICKET_CREATE_FAILED', 'operations.helpdesks.create', [
                'panel' => 'operations',
                'helpdesk_id' => $ticket->getKey(),
                'created_by' => $ticket->created_by,
                'error' => $th->getMessage(),
