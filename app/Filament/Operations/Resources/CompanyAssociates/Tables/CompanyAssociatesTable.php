...
namespace App\Filament\Operations\Resources\CompanyAssociates\Tables;
...
class CompanyAssociatesTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->emptyStateHeading('Sin asociados registrados')
            ->emptyStateDescription('Aún no hay asociados de nuevos negocios registrados.')
