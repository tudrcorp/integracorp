...
class SupplierAcceptanceLettersChart extends ChartWidget
{
    ...
    protected ?string $description = 'Cartas de aceptación cargadas por responsable. Jurídicos: suppliers · Naturales: doctor_nurses. Fuente: auditoría de carga (carta-acceptance.upload).';
    ...
    {
        $series = SupplierAcceptanceLettersChartSeries::groupedByCollaborator($this->resolvedYear());
