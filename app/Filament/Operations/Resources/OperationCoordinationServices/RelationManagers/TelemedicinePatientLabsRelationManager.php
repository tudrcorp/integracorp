            ...
            ->toolbarActions([
                BulkActionGroup::make([
                    BulkAction::make('create_service_order')
                        ...
                        ->modalDescription('Se creara una orden de servicio para los exámenes de laboratorio seleccionados')
                        ->modalSubmitActionLabel('Crear Orden de Servicio')
                        ->modalCancelActionLabel('Cancelar')
                        ->modalWidth(Width::SixExtraLarge)
                        ->form(function (Collection $records): array {
                            $labsList = $records->map(function (TelemedicinePatientLab $record): array {
                                return [
                            ...
                            return [
                                Section::make('Exámenes seleccionados')
                                    ->description('Listado de exámenes de laboratorio incluidos en esta orden.')
                                    ->icon(Heroicon::OutlinedListBullet)
                                    ->schema([
                                        Repeater::make('labs_list')
                                            ->label('')
                                            ->default($labsList)
                                            ->schema([
                                                Grid::make(3)
                                ...
                                Section::make('Detalle del servicio')
                                    ->description('Describe el servicio solicitado para los exámenes seleccionados.')
