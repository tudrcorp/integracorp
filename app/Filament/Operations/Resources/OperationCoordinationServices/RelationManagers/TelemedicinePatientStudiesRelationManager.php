...
class TelemedicinePatientStudiesRelationManager extends RelationManager
{
    ...
    {
        return $table
            ->heading('Estudios de imagenología solicitados')
            ...
            ->toolbarActions([
                BulkActionGroup::make([
                    BulkAction::make('create_service_order')
                        ...
                        ->modalDescription('Se creara una orden de servicio para los estudios de imagenología seleccionados')
                        ->modalSubmitActionLabel('Crear Orden de Servicio')
                        ->modalCancelActionLabel('Cancelar')
                        ->modalWidth(Width::SixExtraLarge)
                        ->form(function (Collection $records): array {
                            $studiesList = $records->map(function (TelemedicinePatientStudy $record): array {
                                return [
                                    'study' => $record->study ?? '-',
                                    'type' => $record->type ?? '-',
                            ...
                            return [
                                Section::make('Estudios seleccionados')
                                    ->description('Listado de estudios de imagenología incluidos en esta orden.')
                                    ->icon(Heroicon::OutlinedListBullet)
                                    ->schema([
                                        Repeater::make('studies_list')
                                            ->label('')
                                            ->default($studiesList)
                                            ->schema([
                                                Grid::make(3)
                                ...
                                Section::make('Detalle del servicio')
                                    ->description('Describe el servicio solicitado para los estudios de imagenología seleccionados.')
