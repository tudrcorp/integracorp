...
class ViewOperationCoordinationService extends ViewRecord
{
    ...
    public function getTitle(): string|\Illuminate\Contracts\Support\Htmlable
    {
        ...
        $referenceNumber = $operationCoordinationService->reference_number ?? 'Sin Nombre';
        ...
        return new \Illuminate\Support\HtmlString(
            '<div style="display: flex; flex-direction: column; font-family: -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, Helvetica, Arial, sans-serif; gap: 2px; padding: 12px 0;">'.
                ...
                'Paciente: '.$operationCoordinationService->patient.
                '</span>'.
                ...
                '">'.
                '<span style="font-size: 10px;">●</span> '.$operationCoordinationService->status.
                '</span>'.
                '</div>'.
                '</div>'
        );
