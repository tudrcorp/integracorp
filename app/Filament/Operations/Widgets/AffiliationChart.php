...
class AffiliationChart extends ChartWidget
{
    ...
    protected ?string $description = 'Visualizacion mensual de afiliaciones con desglose por dias del mes. Haz clic en las barras para observar el detalle o usa el boton para resetear.';
    ...
    public function handleChartClick(array $payload): void
    {
        if ($this->selectedMonth === null) {
            ...
            Notification::make()
                ...
                ->body('Mostrando el total de personas afiliadas por dia.')
                ->info()
                ->send();
        } else {
            $this->selectedMonth = null;
