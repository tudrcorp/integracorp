...
final class HelpdeskTicketModalActions
{
    ...
    {
        return SharedHelpdeskTicketModalActions::makeAddNoteAction('marketing');
    }

    public static function makeUpdateStatusAction(): Action
    {
        return SharedHelpdeskTicketModalActions::makeUpdateStatusAction('marketing');
    }

    public static function makeUpdatePriorityAction(): Action
    {
        return SharedHelpdeskTicketModalActions::makeUpdatePriorityAction('marketing');
    }

    public static function makeReassignAction(): Action
    {
        return SharedHelpdeskTicketModalActions::makeReassignAction('marketing');
    }

    public static function makeRevertToAnalystAction(): Action
    {
        return SharedHelpdeskTicketModalActions::makeRevertToAnalystAction('marketing');
    }

    public static function makeAssignToSprintAction(): Action
    {
        return SharedHelpdeskTicketModalActions::makeAssignToSprintAction('marketing');
    }
}
