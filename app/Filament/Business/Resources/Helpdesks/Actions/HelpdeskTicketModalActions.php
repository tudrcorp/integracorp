...
final class HelpdeskTicketModalActions
{
    ...
    {
        return SharedHelpdeskTicketModalActions::makeAddNoteAction('business');
    }

    public static function makeUpdateStatusAction(): Action
    {
        return SharedHelpdeskTicketModalActions::makeUpdateStatusAction('business');
    }

    public static function makeUpdatePriorityAction(): Action
    {
        return SharedHelpdeskTicketModalActions::makeUpdatePriorityAction('business');
    }

    public static function makeReassignAction(): Action
    {
        return SharedHelpdeskTicketModalActions::makeReassignAction('business');
    }

    public static function makeRevertToAnalystAction(): Action
    {
        return SharedHelpdeskTicketModalActions::makeRevertToAnalystAction('business');
    }

    public static function makeAssignToSprintAction(): Action
    {
        return SharedHelpdeskTicketModalActions::makeAssignToSprintAction('business');
    }
}
