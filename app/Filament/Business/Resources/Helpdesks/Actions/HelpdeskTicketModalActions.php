        ...
        return Action::make('updatePriority')
            ...
            ->action(function (HelpDesk $record, array $data): void {
                ...
                if (! HelpdeskResource::currentUserIsHelpdeskTicketCreator($record)) {
                    SecurityAudit::log('AUDIT_HELPDESK_PRIORITY_UPDATE_DENIED', 'business.helpdesks.update-priority', [
                        'panel' => 'business',
                        'helpdesk_id' => $record->getKey(),
                ...
                if (! in_array($newPriority, $allowed, true)) {
                    SecurityAudit::log('AUDIT_HELPDESK_PRIORITY_UPDATE_FAILED', 'business.helpdesks.update-priority', [
                        'panel' => 'business',
                        'helpdesk_id' => $record->getKey(),
                ...
                if ($newPriority === $previousPriority) {
                    SecurityAudit::log('AUDIT_HELPDESK_PRIORITY_UPDATE_SKIPPED', 'business.helpdesks.update-priority', [
                        'panel' => 'business',
                        'helpdesk_id' => $record->getKey(),
                        'priority' => $record->priority,
                        'updated_by' => $user->name,
                ...
                $whatsAppReport = HelpdeskTicketAssigneeWhatsAppService::dispatchCustomMessageToEachAssigneeWithReport(
                    ...
                    auditRoute: 'business.helpdesks.notifications.whatsapp.priority',
                );
                ...
                SecurityAudit::log('AUDIT_HELPDESK_PRIORITY_UPDATED', 'business.helpdesks.update-priority', [
                    'panel' => 'business',
                    'helpdesk_id' => $record->getKey(),
                    'old_priority' => $previousPriority,
                    'new_priority' => $newPriority,
