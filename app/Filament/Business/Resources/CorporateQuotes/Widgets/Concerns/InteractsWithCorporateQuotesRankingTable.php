...
namespace App\Filament\Business\Resources\CorporateQuotes\Widgets\Concerns;

use Carbon\Carbon;

trait InteractsWithCorporateQuotesRankingTable
{
    ...
    public function bootInteractsWithCorporateQuotesRankingTable(): void
    {
