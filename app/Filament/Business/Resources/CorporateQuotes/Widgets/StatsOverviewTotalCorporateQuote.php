...
class StatsOverviewTotalCorporateQuote extends StatsOverviewWidget
{
    /**
    ...
    protected ?string $heading = 'Total de cotizaciones corporativas';
    ...
    protected function getStats(): array
    {
        ...
        $totalAnio = CorporateQuote::query()
            ->whereBetween('created_at', [$startOfYear, $endOfYear])
            ->count();

        $totalMes = CorporateQuote::query()
