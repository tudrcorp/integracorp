...
class StatsOverviewCorporateQuote extends StatsOverviewWidget
{
    ...
    protected ?string $heading = 'ANÁLISIS DE REGISTROS DE COTIZACIÓN CORPORATIVA EMITIDAS';
    ...
    protected function getStats(): array
    {
        ...
        $plans = [
            '1' => [
                'label' => 'COTIZACIONES CORPORATIVAS PLAN INICIAL',
                'color' => 'info',
            ...
            '2' => [
                'label' => 'COTIZACIONES CORPORATIVAS PLAN IDEAL',
                'color' => 'info',
            ...
            '3' => [
                'label' => 'COTIZACIONES CORPORATIVAS PLAN ESPECIAL',
                'color' => 'info',
            ...
            'CM' => [
                'label' => 'COTIZACIONES CORPORATIVAS MULTIPLAN',
                'color' => 'info',
        ...
        foreach ($plans as $key => $config) {
            $emitidas = CorporateQuote::where('plan', $key)
                ->whereBetween('created_at', [$start, $end])
                ->count();

            $ejecutadas = CorporateQuote::where('plan', $key)
