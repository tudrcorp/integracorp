...
class CorporateQuotesByAgencyTable extends TableWidget
{
    ...
    public function selectAgency(Agency $agency): void
    {
        ...
        $this->dispatch(
            'corporate-quotes-agency-selected',
    ...
    public function viewAgencyQuotesWithoutAgent(Agency $agency): void
    {
        ...
        $this->dispatch(
            'corporate-quotes-filter-by-agency-without-agent',
            agencyCode: $agency->code,
            agencyName: $agency->name_corporative,
    ...
    {
        return CorporateQuotesRankingTableUi::apply(
            table: $table,
            variant: 'agency',
            query: fn (): Builder => CorporateQuotesRankingQuery::agencies(
            ...
            emptyDescription: 'Las cotizaciones corporativas aparecerán aquí agrupadas por agencia.',
            heading: false,
        )
