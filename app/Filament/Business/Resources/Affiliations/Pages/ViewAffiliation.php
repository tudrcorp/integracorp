...
class ViewAffiliation extends ViewRecord
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Action::make('addObservation')
                ...
                ->modalDescription('La observación quedará asociada a esta afiliación y al analista que la registra.')
                ...
                ->action(function (array $data): void {
                    $this->record->affiliationObservations()->create([
                        'description' => $data['description'],
                        'created_by' => (string) Auth::id(),
                    ]);

                    $this->record->unsetRelation('affiliationObservations');
                    $this->record->load('affiliationObservations.createdBy:id,name,email');
            ...
            Action::make('audit')
                ...
                ->modalHeading('Auditoría de la afiliación')
    ...
    public static function auditItemsCatalog(): array
    {
        return [
            'affiliation_info' => [
                ...
                'detail' => 'Información de la afiliación (nombre y apellido del titular, cédula de identidad o RIF, correo electrónico y número de teléfono).',
            ],
            'payer_info' => [
            ...
            'main_documents' => [
                ...
                'detail' => 'Documento principal de la afiliación y los documentos de los afiliados.',
            ],
            'ils_document' => [
    ...
    /**
     * Claves ya auditadas para esta afiliación.
     *
