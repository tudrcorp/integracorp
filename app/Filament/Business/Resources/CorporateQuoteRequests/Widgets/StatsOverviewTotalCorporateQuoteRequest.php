...
class StatsOverviewTotalCorporateQuoteRequest extends StatsOverviewWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $totalAnio = CorporateQuoteRequest::query()
            ->whereBetween('created_at', [$startOfYear, $endOfYear])
            ->count();

        $totalMes = CorporateQuoteRequest::query()
        ...
        return [
            Stat::make('Solicitudes año '.$year, $totalAnio)
            ...
            Stat::make('Solicitudes '.$monthLabel, $totalMes)
                ->description('Registradas en el mes seleccionado')
