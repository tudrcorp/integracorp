...
class StatsOverviewIndividualQuote extends StatsOverviewWidget
{
    ...
    protected function getStats(): array
    {
        ...
        return [
            ...
            Stat::make('COTIZACIONES PLAN INICIAL', IndividualQuote::where('plan', 1)->whereBetween('created_at', [$start, $end])->count())
            ...
            Stat::make('COTIZACIONES PLAN IDEAL', IndividualQuote::where('plan', 2)->whereBetween('created_at', [$start, $end])->count())
                ->description('Mes actual')
            ...
            Stat::make('COTIZACIONES PLAN ESPECIAL', IndividualQuote::where('plan', 3)->whereBetween('created_at', [$start, $end])->count())
                ->description('Mes actual')
            ...
            Stat::make('COTIZACIONES MULTIPLAN', IndividualQuote::where('plan', 'CM')->whereBetween('created_at', [$start, $end])->count())
                ->description('Mes actual')
