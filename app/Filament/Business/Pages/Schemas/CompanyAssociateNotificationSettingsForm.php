...
final class CompanyAssociateNotificationSettingsForm
{
    ...
    private static function emailSection(): Section
    {
        return Section::make('Correos electrónicos')
            ->description('Analistas que recibirán el detalle del registro por email con encabezado INTEGRACORP.')
    ...
    private static function phoneSection(): Section
    {
        return Section::make('Teléfonos WhatsApp')
            ->description('Números móviles que recibirán la alerta con imagen de marca y recordatorio del voucher ILS.')
