                        ...
                        ->schema([
                            ...
                            Grid::make(3)->schema([
                                Select::make('individual_quote_id')
                                    ...
                                    ->dehydrated()
                                    ->prefixIcon('heroicon-m-clipboard-document-check')
                                    ->options(IndividualQuote::select('id', 'agent_id', 'status', 'full_name')->where('status', 'APROBADA')->pluck('full_name', 'id'))
                                    ->default(function () {
                                        $id = request()->query('id');
                                        if (isset($id)) {
                                            return $id;
                                ...
                                Hidden::make('agent_id')->default(null),
                                Hidden::make('code_agency')->default(null),
