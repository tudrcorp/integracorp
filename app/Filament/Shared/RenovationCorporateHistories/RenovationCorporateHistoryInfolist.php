...
class RenovationCorporateHistoryInfolist
{
                                        ...
                                        Grid::make(4)
                                            ...
                                            ->schema([
                                                ...
                                                TextEntry::make('affiliationCorporate.name_corporate')
                                                    ...
                                                    ->icon('heroicon-m-user')
                                                    ->placeholder('—'),
                                                TextEntry::make('affiliationCorporate.nro_identificacion_ti')
                                                ...
                                                TextEntry::make('remaining_days_at_accept')
                                                    ...
                                                    ->badge()
                                                    ->color(fn (AffiliationCorporateRenovationHistory $record): string => match (true) {
                                        ...
                                        Grid::make(4)
                                            ...
                                            ->schema([
                                                TextEntry::make('plan.description')
                                                    ->label('Plan aplicado')
                                                    ->badge()
                                                    ->color(fn (AffiliationCorporateRenovationHistory $record): string => match ((int) $record->plan_id) {
                                                ...
                                                TextEntry::make('previousPlan.description')
                                                    ...
                                                    ->badge()
                                                    ->color('gray')
                                                    ->visible(fn (AffiliationCorporateRenovationHistory $record): bool => filled($record->previous_plan_id))
                                                    ->placeholder('—'),
                                        ...
                                        Grid::make(2)
                                            ...
                                            ->schema([
                                                ...
                                                TextEntry::make('negotiation_notes')
                                                    ...
                                                    ->visible(fn (AffiliationCorporateRenovationHistory $record): bool => $record->is_negotiation_candidate),
                                            ]),
                                    ]),
                            ]),
