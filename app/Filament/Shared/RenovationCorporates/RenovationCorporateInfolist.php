                                        ...
                                        Grid::make(4)
                                            ...
                                            ->schema([
                                                ...
                                                TextEntry::make('remaining_days')
                                                    ...
                                                    ->badge()
                                                    ->color(fn (RenovationCorporate $record): string => match (true) {
                                                ...
                                                TextEntry::make('affiliationCorporate.status')
                                        ...
                                        Grid::make(4)
                                            ...
                                            ->schema([
                                                TextEntry::make('plan.description')
                                                    ...
                                                    ->badge()
                                                    ->color(fn (RenovationCorporate $record): string => match ((int) $record->plan_id) {
                                                ...
                                                TextEntry::make('previousPlan.description')
                                                    ...
                                                    ->badge()
                                                    ->color('gray')
                                                    ->visible(fn (RenovationCorporate $record): bool => filled($record->previous_plan_id))
                                                    ->placeholder('—'),
                                                TextEntry::make('coverage.price')
                                                    ->label('Cobertura (US$)')
                                                    ->formatStateUsing(fn ($state, RenovationCorporate $record): string => $record->coverage_id
                                        ...
                                        Grid::make(2)
                                            ...
                                            ->schema([
                                                ...
                                                TextEntry::make('negotiation_notes')
                                                    ...
                                                    ->visible(fn (RenovationCorporate $record): bool => $record->is_negotiation_candidate),
                                            ]),
                                    ]),
                            ]),
                                ...
                                Section::make('Jerarquía comercial')
                                    ...
                                    ->schema([
                                        Grid::make(4)
                                            ->extraAttributes(['class' => self::IOS_INNER_CLASS])
                                            ->schema([
                                                TextEntry::make('affiliationCorporate.agency.name_corporative')
                                                    ->label('Agencia')
                                                ...
                                                TextEntry::make('code_agency')
                                                    ...
                                                    ->badge()
                                                    ->color('gray'),
                                                TextEntry::make('affiliationCorporate.agent.name')
                                                    ->label('Agente')
