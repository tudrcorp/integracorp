...
/**
 * Copia de {@see \Filament\Widgets\Concerns\InteractsWithPageTable} con
 * `tableColumnSearches` como `?array`: Livewire puede hidratar `null` en props
 * reactivas; en PHP 8.4 no se puede asignar `null` a una propiedad tipada `array`.
 */
trait InteractsWithPageTable /** @phpstan-ignore trait.unused */
{
     ...
     */
    #[Reactive]
    public ?array $tableColumnSearches = null;
