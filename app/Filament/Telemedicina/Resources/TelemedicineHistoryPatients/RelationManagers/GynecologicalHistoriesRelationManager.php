...
class GynecologicalHistoriesRelationManager extends RelationManager
{
    protected static string $relationship = 'gynecologicalHistories';

    protected static ?string $title = 'Histórico Antecedentes Ginecologicos';
    ...
    {
        return $table
            ->heading('Antecedentes Ginecológicos')
            ->description('Ordenados de forma cronológica desde el más reciente hasta el más antiguo.')
            ->emptyStateHeading('Sin antecedentes ginecológicos')
            ->emptyStateDescription('Aún no se han registrado antecedentes ginecológicos. Use «Nuevo Antecedente» para añadir el primero.')
            ...
            ->columns([
                TextColumn::make('created_at')
                    ...
                    ->dateTime('d/m/Y H:i')
                    ->description(fn (GynecologicalHistory $record): string => $record->updated_at?->diffForHumans() ?? '—')
                    ->color('primary')
            ...
            ->headerActions([
                CreateAction::make()
                    ...
                    ->modalHeading('Registro de Nuevo Antecedente Ginecológico')
                    ...
                    ->action(function (RelationManager $livewire, array $data) {
                        try {
                            $record = new GynecologicalHistory;
