...
class SurgicalHistoriesRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateHeading('Sin antecedentes quirúrgicos')
            ->emptyStateDescription('Aún no se han registrado antecedentes quirúrgicos. Use «Nuevo Antecedente» para añadir el primero.')
