...
class NoPathologicalHistoriesRelationManager extends RelationManager
{
    protected static string $relationship = 'noPathologicalHistories';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateHeading('Sin antecedentes no patológicos')
            ->emptyStateDescription('Aún no se han registrado antecedentes no patológicos. Use «Nuevo Antecedente» para añadir el primero.')
            ...
            ->columns([
                TextColumn::make('created_at')
                    ...
                    ->dateTime('d/m/Y H:i')
                    ->description(fn (NoPathologicalHistory $record): string => $record->updated_at?->diffForHumans() ?? '—')
                    ->color('primary')
            ...
            ->headerActions([
                CreateAction::make()
                    ...
                    ->modalHeading('Registro de Nuevo Antecedente No Patológico')
                    ...
                    ->action(function (RelationManager $livewire, array $data) {
                        try {
                            $record = new NoPathologicalHistory;
