...
class TelemedicineHistoryPatientForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                Tabs::make('telemedicineHistoryPatientTabs')
                    ->columnSpanFull()
                    ->tabs([
                        ...
                        //         ])->columnSpanFull()->columns(5),
                        // ])->columnSpanFull(),
                        Tab::make('Antecedentes familiares')
                        ...
                        Tab::make('Antecedentes personales')
                        ...
                        Tab::make('Antecedentes quirúrgicos')
                        ...
                        Tab::make('Antecedentes ginecológicos')
                            ->icon('heroicon-o-user')
                            ->schema([
                                Section::make('Antecedentes Ginecológicos')
                                    ->collapsible()
                                    ->hidden(function (Get $get): bool {
                                        if ($get('telemedicine_patient_id') !== null) {
                                            $sex = TelemedicinePatient::query()
                                                ->whereKey($get('telemedicine_patient_id'))
                                                ->value('sex');
